...
text.innerHTML = `
<strong>Description:</strong> Another huge advantage of the spread syntax, is the ability to combine arrays, or to insert all the elements of 
one array into another, at any index. With more traditional syntaxes, we can concatenate arrays, but this only allows us to combine arrays at 
...
<strong>Instructions:</strong> <strong>Instructions:</strong> We have defined a function <code>spreadOut</code> that returns the variable <code>sentence</code>, modify the function using the spread syntax so that it returns the array <code>['learning', 'to', 'code', 'is', 'fun']</code>.`;
